...
export const ProductionOrdersPage = () => {
  ...
  const updateStatusMutation = useMutation({
    mutationFn: ({
      ...
      productionService.updateOrderStatus(orderId, {
  ...
  const openProcessesModal = async (order: ProductionOrder) => {
    ...
    const freshOrders = (await queryClient.getQueryData([
      "production-orders",
      selectedStatus,
      dateFrom,
      dateTo,
    ...
    const freshOrder =
      freshOrders?.find((o: ProductionOrder) => o.id === order.id) || order;
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                      ...
                      <div>
                        <p className="text-sm text-gray-600">
                          {t("production.completedQuantity")}
                        </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg mb-4">
                  <p className="text-sm text-blue-800">
                    💡 <span className="font-semibold">Order Number</span> will
                    be auto-generated (format: PO-YYYYMMDD-XXXX)
                  </p>
                </div>
              ...
              <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-gray-50 rounded-lg">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">
                      {selectedOrder.targetQuantity.toLocaleString()}{" "}
                      {t("production.units")}
                    </p>
                  </div>
                  <div>
